    ...
    case 'cta':
      return (
        <div key={index} className="bg-brand-50 border border-brand-100 rounded-xl p-6 my-8 text-center">
          <p className="font-display font-bold text-gray-900 text-lg mb-2">{block.text || 'Get a Free Match'}</p>
          <p className="text-sm text-gray-600 mb-4">Speak to vetted private investigators in London. Confidential, free matching service.</p>
        </div>
      );
            ...
            <aside className="lg:col-span-1">
              <div className="sticky top-28 space-y-8">
                <div className="bg-white p-6 rounded-2xl shadow-lg border border-gray-100">
                  <h3 className="text-lg font-display font-bold text-gray-900 mb-3">Get a Free Match</h3>
                  <p className="text-gray-600 text-sm mb-5">
                    Ready to find an investigator? We will match you with a vetted private investigator in London at no cost.
                  </p>
                  <button
