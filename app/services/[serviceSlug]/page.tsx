            ...
            <div className="lg:col-span-2">
              ...
              <section className="mb-14">
                ...
                <p className="text-gray-600 text-sm mt-4">
                  Our matched investigators will review your case requirements and provide a clear proposal before any work begins.
                </p>
              </section>
            ...
            <aside className="lg:col-span-1">
              <div className="sticky top-28 space-y-6">
                <div className="bg-white p-6 rounded-2xl shadow-lg border border-gray-100">
                  ...
                  <p className="text-gray-600 mb-5 text-sm">Confidential match with vetted private investigators in your area.</p>
                  <button onClick={() => setIsModalOpen(true)} className="block w-full btn-primary text-center">Find an Investigator</button>
                  <div className="mt-5 pt-5 border-t border-gray-100 space-y-3">
                    {[
                      { icon: <Clock className="w-4 h-4 text-brand-500" />, text: "Consultations available this week" },
                      { icon: <Shield className="w-4 h-4 text-brand-500" />, text: "Vetted London investigators" },
