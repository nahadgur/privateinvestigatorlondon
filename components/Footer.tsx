    ...
    <footer className="bg-gray-900 text-gray-300 pt-16 pb-8">
      <div className="container-width">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 mb-12">
          <div>
            ...
            <p className="text-sm text-gray-400 leading-relaxed mb-4">
              Confidential matching service for London clients. We connect individuals and businesses with vetted private investigators across London.
            </p>
            <p className="text-xs text-gray-500 italic border-l-2 border-gray-700 pl-3">
              We are a referral and matching service, not a private investigation firm. All work is carried out by independent investigators in our vetted network.
            </p>
          </div>

          <div>
            <h4 className="text-white font-semibold mb-4">Investigation Services</h4>
          ...
          <div>
            <h4 className="text-white font-semibold mb-4">London Areas</h4>
            <ul className="space-y-2 text-sm">
        ...
        <div className="border-t border-gray-800 pt-8 text-sm text-gray-500 flex flex-col md:flex-row justify-between items-center gap-4">
          <p>&copy; {new Date().getFullYear()} {siteConfig.name}. We are a matching service, not a private investigation firm.</p>
