        ...
        <div className="p-8">
          {isSuccess ? (
            <div className="flex flex-col items-center text-center py-8 space-y-4">
              ...
              <p className="text-gray-600">We have matched you with a vetted private investigator. Check your email for next steps.</p>
            </div>
          ) : (
            <>
              <div className="mb-6">
                ...
                <p className="text-gray-600 text-sm mt-1">Fill in your details below and we will connect you with a vetted private investigator.</p>
              </div>
